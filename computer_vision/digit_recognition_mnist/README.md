...
digit\_recognition\_mnist/  

├── data/        # mnist\_dataset.csv (raw dataset or fallback to keras.datasets.mnist)  

├── src/         # pipeline.py (10-step ML workflow)  

├── results/     # metrics.json, sample\_digits.png  

├── models/      # mnist\_cnn.h5 (trained CNN model)  
...
\- \*\*Source\*\*: MNIST dataset (`mnist\_dataset.csv` or keras.datasets.mnist)  
...
\- `results/sample\_digits.png` → visualization of sample digits with labels
